...
#    listof_sentn = []    
#    for chapter in dict_books.values():
...
def ratioSpeech(dict_books):
    ...
    print("Number of direct speech sentences: ", direct_speech)
    #print(direct_speech)
    print("Ratio of direct speech to indirect speech is: ", "{0:.2f}".format(ratio))
